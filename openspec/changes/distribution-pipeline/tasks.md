...
- [ ] 2.1 Install GoReleaser (`brew install goreleaser` or download)
...
- [ ] 2.5 Test local build with `goreleaser release --snapshot --clean`
...
- [ ] 4.4 Test `brew tap coliva/tsk && brew install tsk`
...
- [ ] 5.8 Test on macOS and Linux

## 6. Testing & Documentation

- [ ] 6.1 Create first release tag to test full pipeline
- [ ] 6.2 Verify all platform binaries in GitHub Release
- [ ] 6.3 Test `go install github.com/coliva/tsk@latest`
- [ ] 6.4 Test Homebrew installation flow
- [ ] 6.5 Test curl installer on clean system
